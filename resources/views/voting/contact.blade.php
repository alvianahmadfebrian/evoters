...
<div class="space-y-12 relative overflow-hidden pb-16">
    ...
    <section class="text-center max-w-3xl mx-auto space-y-4 pt-6 reveal">
        ...
        <h1 class="text-3xl md:text-5xl font-extrabold tracking-tight leading-tight" style="color: #0f172a;">
            Kontak & Informasi <span style="color: #ba7c21;">Resmi Usaha</span>
        </h1>
    ...
    <section class="max-w-5xl mx-auto reveal">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="contact-card glass-card rounded-3xl border border-slate-200/90 bg-white p-6 flex flex-col justify-between space-y-4">
                ...
                <div class="pt-3 border-t border-slate-100 text-[11px] text-amber-700 font-semibold flex items-center gap-1.5">
            ...
            <div class="contact-card glass-card rounded-3xl border border-slate-200/90 bg-white p-6 flex flex-col justify-between space-y-4">
                ...
                <div class="pt-3 border-t border-slate-100">
                    <a href="https://wa.me/{{ config('company.whatsapp') }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-1.5 text-xs font-bold text-amber-600 hover:text-amber-700 transition-colors">
            ...
            <div class="contact-card glass-card rounded-3xl border border-slate-200/90 bg-white p-6 flex flex-col justify-between space-y-4">
                ...
                <div class="pt-3 border-t border-slate-100">
                    <a href="mailto:{{ config('company.email') }}" class="inline-flex items-center gap-1.5 text-xs font-bold text-amber-600 hover:text-amber-700 transition-colors">
    ...
    <section class="max-w-5xl mx-auto reveal">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="glass-card rounded-3xl border border-slate-200/90 bg-white p-8 md:p-10 space-y-6 shadow-md">
                <div class="space-y-2">
                    <div class="inline-flex items-center space-x-2 px-3 py-1 rounded-full text-xs font-semibold" style="background: #fcf5e2; border: 1px solid #f7e6bb; color: #9b5f1a;">
                ...
                <div class="space-y-4 text-sm text-slate-700">
                    <div class="flex items-start gap-3 p-3.5 rounded-2xl bg-slate-50 border border-slate-100">
                        <i class="fa-solid fa-building text-[#ba7c21] mt-0.5 flex-shrink-0"></i>
                        <div>
                            <span class="text-xs text-slate-400 block font-medium">Nama Usaha / Lembaga:</span>
                            <span class="font-bold text-slate-800">{{ config('company.name') }}</span>
                        </div>
                    </div>

                    <div class="flex items-start gap-3 p-3.5 rounded-2xl bg-slate-50 border border-slate-100">
                        <i class="fa-solid fa-map-location-dot text-[#ba7c21] mt-0.5 flex-shrink-0"></i>
                        <div>
                            <span class="text-xs text-slate-400 block font-medium">Domisili Kantor Operasional:</span>
                            <span class="font-semibold text-slate-800 leading-relaxed">{{ config('company.address') }}</span>
                        </div>
                    </div>
                </div>

                <div class="p-4 rounded-2xl bg-[#fcf5e2] border border-[#f7e6bb] text-xs text-[#9b5f1a] leading-relaxed flex items-start gap-3">
                    <i class="fa-solid fa-circle-check text-[#ba7c21] text-sm mt-0.5"></i>
                    <div>
            ...
            <div class="glass-card rounded-3xl border border-slate-200/90 bg-white p-8 md:p-10 space-y-6 shadow-md flex flex-col justify-between">
                ...
                <div class="space-y-4">
                    <!-- WhatsApp Action Box -->
                    <div class="p-5 rounded-2xl text-white space-y-3 shadow-lg shadow-[#ba7c21]/20" style="background: linear-gradient(135deg, #ba7c21, #9b5f1a);">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-amber-100">Aktif pada jam kerja operasional</p>
                            </div>
                        </div>
                        ...
                        <a href="https://wa.me/{{ config('company.whatsapp') }}?text=Halo%20Admin%20eVoters,%20saya%20membutuhkan%20informasi%20terkait%20platform%20voting" target="_blank" rel="noopener noreferrer" class="block w-full text-center bg-white text-[#9b5f1a] font-bold text-xs py-3 px-4 rounded-xl shadow hover:bg-slate-50 transition-colors">
