...
<style>
    ...
    .feature-row:hover { background: #fffdfa; }
...
<div class="space-y-16 relative overflow-hidden pb-16">
    ...
    <div class="absolute -top-40 left-1/4 w-[600px] h-[600px] bg-[#ba7c21]/[0.04] rounded-full blur-3xl pointer-events-none"></div>
    <div class="absolute top-[500px] right-1/4 w-[500px] h-[500px] bg-[#9b5f1a]/[0.04] rounded-full blur-3xl pointer-events-none"></div>
    ...
    <section class="text-center max-w-3xl mx-auto space-y-5 pt-8 reveal">
        ...
        <h1 class="text-4xl md:text-5xl font-extrabold tracking-tight leading-tight" style="color: #0f172a;">
            ...
            <span style="color: #ba7c21;">Lebih Praktis & Transparan</span>
        </h1>
    </section>

    <!-- Card 1: Apa Itu E-Voters.id? -->
    <section class="max-w-5xl mx-auto reveal reveal-1 mb-6">
        <div class="glass-card rounded-3xl border border-slate-100 shadow-md p-8 md:p-12 bg-gradient-to-br from-white via-white to-amber-50/[0.08]">
            <div class="max-w-4xl space-y-5">
                <div class="space-y-1.5">
                    <span class="text-xs md:text-sm font-bold uppercase tracking-wider" style="color: #ba7c21;">Kenali Platform Kami</span>
                    <h2 class="text-3xl md:text-4xl font-extrabold tracking-tight" style="color: #0f172a;">
                        Apa Itu <span style="color: #ba7c21;">E-Voters.id</span>?
                    </h2>
                    <div class="w-16 h-0.5 rounded-full mt-2" style="background: #ba7c21;"></div>
                </div>
    ...
    <section class="max-w-5xl mx-auto reveal reveal-1 mb-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <!-- Visi -->
            <div class="glass-card rounded-3xl border border-slate-100 shadow-md p-8 md:p-10 bg-gradient-to-br from-white via-white to-amber-50/[0.08] space-y-4">
                <div>
            ...
            <div class="glass-card rounded-3xl border border-slate-100 shadow-md p-8 md:p-10 bg-gradient-to-br from-white via-white to-amber-50/[0.08] space-y-4">
                ...
                <ul class="space-y-3 text-sm md:text-base pt-1 text-justify" style="color: #475569;">
                    <li class="flex items-start space-x-3">
                        <span class="w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0" style="background: #fcf5e2; color: #ba7c21;">
    ...
    <section class="max-w-5xl mx-auto reveal reveal-1">
        <div class="glass-card rounded-3xl border border-slate-100 shadow-md overflow-hidden bg-gradient-to-br from-white via-white to-amber-50/[0.08]">
            <div class="flex flex-col md:flex-row md:items-center gap-10 p-8 md:p-12">
                ...
                <div class="w-full md:w-3/5 space-y-5">
                    <div class="space-y-1.5">
                        <span class="inline-flex items-center space-x-1.5 text-[11px] font-semibold px-3 py-1 rounded-full mb-1" style="background: #fcf5e2; border: 1px solid #f7e6bb; color: #9b5f1a;">
