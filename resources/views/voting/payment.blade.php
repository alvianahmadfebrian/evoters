...
<div class="max-w-xl mx-auto py-8 md:py-12">
    ...
    <div class="flex items-center justify-between max-w-sm mx-auto mb-10 px-4">
        ...
        <div class="flex flex-col items-center flex-1 relative">
            <div class="w-8 h-8 rounded-full text-white font-extrabold text-xs flex items-center justify-center shadow-lg shadow-[#ba7c21]/25 border-2 border-[#f7e6bb]" style="background: #ba7c21;">
        ...
        <!-- Line -->
        <div class="h-[2px] flex-grow -mt-6" style="background: rgba(186, 124, 33, 0.6);"></div>
    ...
    <div class="glass-card rounded-[2.75rem] p-6 md:p-10 border border-slate-200/80 shadow-2xl relative overflow-hidden bg-white/95">
        ...
        <div class="absolute -top-40 -left-40 w-80 h-80 bg-[#ba7c21]/5 rounded-full blur-[80px]"></div>
        <div class="absolute -bottom-40 -right-40 w-80 h-80 bg-[#9b5f1a]/5 rounded-full blur-[80px]"></div>

        <div class="relative z-10 space-y-6">
            <!-- Header section -->
            <div class="text-center space-y-2">
                <span class="inline-flex items-center px-3.5 py-1 rounded-full text-[9px] font-black tracking-widest uppercase" style="background: #fcf5e2; border: 1px solid #f7e6bb; color: #9b5f1a;">
            ...
            <div class="flex items-center space-x-4 p-4.5 rounded-[2rem] bg-slate-50/50 border border-slate-200/30 hover:bg-slate-50 transition-all duration-300">
                ...
                <div class="text-left flex-grow space-y-0.5">
                    <span class="text-[8px] uppercase font-bold px-2 py-0.5 rounded-lg tracking-wider" style="background: #fcf5e2; border: 1px solid #f7e6bb; color: #9b5f1a;">Kandidat Pilihan</span>
            ...
            <div class="relative rounded-3xl border border-slate-200/50 bg-white/50 overflow-hidden shadow-sm">
                ...
                <div class="p-6 space-y-4 text-left text-xs relative z-10">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <span class="font-extrabold uppercase text-[9px] tracking-wider px-2 py-0.5 rounded" style="background: #fcf5e2; border: 1px solid #f7e6bb; color: #9b5f1a;">Gratis</span>
                    </div>
                    ...
                    <div class="flex justify-between items-center pt-1">
                        ...
                        <span class="font-extrabold flex items-center space-x-1" style="color: #ba7c21;">
                ...
                <div class="border-t border-slate-200/30 px-6 py-5 flex items-center justify-between relative z-10" style="background: linear-gradient(135deg, #fefcf6, #fcf5e2);">
                    <span class="text-slate-800 font-black text-xs uppercase tracking-widest">Total Pembayaran</span>
                    <span class="text-2xl font-black tracking-tight" style="color: #ba7c21;">Rp {{ number_format($vote->amount, 0, ',', '.') }}</span>
                </div>
            </div>
            ...
            <div class="space-y-3 pt-1 text-center">
                ...
                <div class="flex flex-wrap items-center justify-center gap-4 py-2.5 px-4 rounded-2xl bg-slate-50/50 border border-slate-200/20 max-w-sm mx-auto">
                    <span class="text-[11px] font-black italic tracking-wider text-slate-800">
                        QR<span class="text-cyan-500">I</span><span style="color: #ba7c21;">S</span>
                    </span>
            ...
            <div class="space-y-3 pt-3">
                <!-- Main Pay Button -->
                <button type="button" onclick="triggerPayment()" class="w-full text-white font-bold text-sm py-4 px-6 rounded-2xl shadow-lg shadow-[#ba7c21]/20 hover:shadow-[#ba7c21]/30 transition-all cursor-pointer flex items-center justify-center space-x-2 border-none transform hover:-translate-y-0.5 active:translate-y-0 duration-150 hover:opacity-95" style="background: linear-gradient(135deg, #ba7c21, #9b5f1a);">
